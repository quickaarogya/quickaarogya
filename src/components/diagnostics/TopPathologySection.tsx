...
import { ChevronRight, ChevronLeft, FlaskConical, Home, ShieldCheck } from 'lucide-react';
...
export function TopPathologySection({ items = initialPathologyTests, itemsPerPage = 18 }: TopPathologySectionProps) {
