...
export const initialDoctors: Doctor[] = [
  {
    ...
    hospitalName: 'Bhagyodaya Tirth Hospital & Research Institute',
    clinicAddress: 'Cardiac Wing, OPD Block 1, Bhagyodaya Tirth Hospital',
    avatarUrl: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=500&auto=format&fit=crop&q=80',
    availableDays: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
    availableSlots: ['09:00 AM', '10:00 AM', '11:00 AM', '02:00 PM', '04:00 PM', '05:30 PM'],
    isVerified: true,
    about: 'Renowned cardiologist with 18+ years of expertise in angioplasty, complex pacemaker implantations, cardiac rehabilitation, and acute coronary care.'
  },
  {
    id: 'doc-bt-2',
    ...
    consultationTypes: ['in_person', 'video_teleconsult'],
    hospitalName: 'Bhagyodaya Tirth Hospital & Research Institute',
    clinicAddress: 'Child Care Wing, OPD Block 2, Bhagyodaya Tirth Hospital',
    avatarUrl: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=500&auto=format&fit=crop&q=80',
    availableDays: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
    availableSlots: ['09:30 AM', '10:30 AM', '11:30 AM', '03:00 PM', '04:30 PM', '06:00 PM'],
    isVerified: true,
    about: 'Dedicated pediatric specialist offering gentle and comprehensive child wellness, newborn immunization, developmental tracking, and critical pediatric care.'
  },
  {
    id: 'doc-bt-3',
    name: 'Dr. Prateek Sharma',
    title: 'Head Orthopedic & Joint Replacement Surgeon',
    specialization: 'Orthopedics',
    qualification: 'MBBS, MS (Orthopedics), MCh (Joint Replacements)',
    experienceYears: 19,
    consultationFee: 550,
    ratingAverage: 4.92,
    ratingCount: 710,
    ...
    consultationTypes: ['in_person', 'video_teleconsult'],
    hospitalName: 'Bhagyodaya Tirth Hospital & Research Institute',
    clinicAddress: 'Joint & Spine Clinic, OPD Block 1, Bhagyodaya Tirth Hospital',
    avatarUrl: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=500&auto=format&fit=crop&q=80',
    availableDays: ['Monday', 'Wednesday', 'Friday', 'Saturday'],
    availableSlots: ['10:00 AM', '11:00 AM', '12:00 PM', '03:30 PM', '05:00 PM'],
    isVerified: true,
    about: 'Expert in primary & revision knee and hip arthroplasty, sports ligament reconstructions, complex trauma fixation, and non-surgical arthritis management.'
  },
  {
    id: 'doc-bt-4',
    name: 'Dr. Richa Dubey',
    title: 'Chief Gynecologist & Laparoscopic Surgeon',
    specialization: 'Gynecology',
    qualification: 'MBBS, MS (OB-GYN), FMAS, FICOG',
    experienceYears: 16,
    consultationFee: 500,
    ratingAverage: 4.96,
    ratingCount: 890,
    ...
    consultationTypes: ['in_person', 'video_teleconsult'],
    hospitalName: 'Bhagyodaya Tirth Hospital & Research Institute',
    clinicAddress: 'Women Care Wing, OPD Block 3, Bhagyodaya Tirth Hospital',
    ...
    isVerified: true,
    about: 'Specialized in high-risk obstetric deliveries, minimally invasive laparoscopic gynecological procedures, infertility counseling, and adolescent healthcare.'
  },
  {
    id: 'doc-bt-5',
    name: 'Dr. Vikas Patni',
    ...
    consultationTypes: ['in_person', 'video_teleconsult'],
    hospitalName: 'Bhagyodaya Tirth Hospital & Research Institute',
    clinicAddress: 'Neuroscience Clinic, OPD Block 2, Bhagyodaya Tirth Hospital',
    avatarUrl: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=500&auto=format&fit=crop&q=80',
    availableDays: ['Monday', 'Tuesday', 'Thursday', 'Friday'],
    availableSlots: ['10:00 AM', '11:00 AM', '02:00 PM', '03:30 PM'],
    isVerified: true,
    about: 'Experienced neurologist managing stroke recovery, epilepsy, migraine, neuropathies, and neuro-rehabilitation.'
  },
  {
    id: 'doc-bt-6',
    name: 'Dr. Pooja Chhabra',
    ...
    consultationTypes: ['in_person', 'video_teleconsult'],
    hospitalName: 'Bhagyodaya Tirth Hospital & Research Institute',
    clinicAddress: 'Skin & Laser Suite, OPD Block 1, Bhagyodaya Tirth Hospital',
    avatarUrl: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=500&auto=format&fit=crop&q=80',
    availableDays: ['Monday', 'Wednesday', 'Friday', 'Saturday'],
    availableSlots: ['09:30 AM', '11:00 AM', '03:00 PM', '04:30 PM'],
    isVerified: true,
    about: 'Clinical dermatologist specializing in acne therapies, laser treatments, allergy patch tests, and hair rejuvenation.'
  },
  {
    id: 'doc-bt-7',
    ...
    qualification: 'MBBS, MD, Fellowship in Diabetes Care',
    experienceYears: 15,
    consultationFee: 500,
    ratingAverage: 4.93,
    ratingCount: 610,
    ...
    consultationTypes: ['in_person', 'video_teleconsult'],
    hospitalName: 'Bhagyodaya Tirth Hospital & Research Institute',
    clinicAddress: 'Diabetes & Metabolism Wing, OPD Block 3, Bhagyodaya Tirth Hospital',
    avatarUrl: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=500&auto=format&fit=crop&q=80',
    availableDays: ['Tuesday', 'Wednesday', 'Friday', 'Saturday'],
    availableSlots: ['09:00 AM', '10:30 AM', '02:30 PM', '04:00 PM'],
    isVerified: true,
    about: 'Expert care for type-1 and type-2 diabetes, gestational diabetes, thyroid imbalances, and obesity management.'
  },
  {
    id: 'doc-bt-8',
    ...
    hospitalName: 'Bhagyodaya Tirth Hospital & Research Institute',
    clinicAddress: 'Dental Care Unit, Ground Floor, Bhagyodaya Tirth Hospital',
    avatarUrl: 'https://images.unsplash.com/photo-1594824813620-21f45610a26d?w=500&auto=format&fit=crop&q=80',
    availableDays: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Saturday'],
    availableSlots: ['10:00 AM', '11:30 AM', '03:00 PM', '05:00 PM'],
    isVerified: true,
    about: 'Painless root canal therapies, dental implants, cosmetic veneers, and routine preventative oral care.'
  },
  {
    id: 'doc-1',
    name: 'Dr. Ananya Roy',
...
export const initialHospitals: Hospital[] = [
  {
    id: 'hosp-bhagyodaya',
    name: 'Bhagyodaya Tirth Hospital & Research Institute',
    type: 'Super Specialty',
    address: 'Khurai Road, Sagar',
    city: 'Sagar, Madhya Pradesh',
    distanceKm: 1.8,
    emergencyHelpline: '07582-281200 / +91 7582 281201',
    has24x7Emergency: true,
    icuBedsAvailable: 24,
    totalBeds: 650,
    rating: 4.95,
    facilities: ['24/7 Multi-Trauma Center', 'Advanced Cath Lab', 'Neonatal & Pediatric ICU', 'Modular OT Complex', 'ABDM Integrated OPD'],
